function toggleMenu() {
  ...
  navbar.style.left = header.classList.contains("is-active") ? "0px" : "-100%";
}
...
document.addEventListener("DOMContentLoaded", function () {
  function drawing() {
    ...
    for (var i = 0; i <= hmTimes; i++) {
      ...
      ctx.fillStyle =
        "hsla(" + randomHue + ", 30%, 80%, ." + opacityOne + opacityTwo + ")";
  ...
  function startExperience() {
    ...
    document.querySelector(".skip-intro").style.display = "block";
